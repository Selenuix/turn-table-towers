...
export const RoomInfo = ({room, players, isGameInProgress, onCopyInviteLink}: RoomInfoProps) => {
  return (<Card className="bg-slate-800/50 border-slate-700">
    <CardHeader>
      <div className="flex items-center justify-between">
        ...
        <Badge
          className={room.status === RoomStatusEnum.WAITING ? 'bg-green-500/20 text-green-400 border-green-500/30' : 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30'}
        >
